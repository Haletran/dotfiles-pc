...
#include "/home/bapasqui/.cache/wal/colors-wal-dwm.h"
#include <X11/XF86keysym.h>

/* appearance */
static const unsigned int borderpx  = 1;        /* border pixel of windows */
static const unsigned int gappx     = 10; 
static const unsigned int topbarpx = 10;       /* gaps between windows */
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_agrave, tag,            {.ui = ~0 } },	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } },
	{ MODKEY,                       XK_semicolon, focusmon,    {.i = +1 } },	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },
	...
	{ MODKEY,                       XK_space,  spawn,          SHCMD("~/.local/bin/toggle_keymap.sh") },
